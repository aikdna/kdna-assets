...
`@aikdna/laozi-wuwei@0.1.0` is a public, experimental judgment asset. It is an
...
curl -LO https://github.com/aikdna/kdna-assets/releases/download/sage-reference-assets-v0.1.0/laozi-wuwei-0.1.0.kdna
curl -LO https://github.com/aikdna/kdna-assets/releases/download/sage-reference-assets-v0.1.0/laozi-wuwei-0.1.0.kdna.sha256
shasum -a 256 -c laozi-wuwei-0.1.0.kdna.sha256
kdna validate laozi-wuwei-0.1.0.kdna
kdna plan-load laozi-wuwei-0.1.0.kdna --json
kdna load laozi-wuwei-0.1.0.kdna --profile=compact --as=json
```
